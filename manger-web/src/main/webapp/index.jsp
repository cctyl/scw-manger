...
<div class="navbar-wrapper">
    <div class="container">
		<%pageContext.setAttribute("navinfo", "创意产品众筹平台"); %>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <a class="left carousel-control" href="${ctp}/#myCarousel" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left"></span>
        <span class="sr-only">Previous</span>
    </a>
    <a class="right carousel-control" href="${ctp}/#myCarousel" role="button" data-slide="next">
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <img class="img-circle" src="${ctp}/img/p1.jpg" alt="Generic placeholder image"
        ...
        <div class="col-lg-4">
            <img class="img-circle" src="${ctp}/img/p2.jpg" alt="Generic placeholder image"
                 style="width: 140px; height: 140px;">
            <h2>NEOKA智能手环</h2>
        ...
        <div class="col-lg-4">
            <img class="img-circle" src="${ctp}/img/p3.png" alt="Generic placeholder image"
                 style="width: 140px; height: 140px;">
            <h2>驱蚊扣</h2>
                ...
                <div id="footer">
                    <div class="footerNav">
                        <a rel="nofollow" href="http://www.atguigu.com">关于我们</a> | <a rel="nofollow"
                                                                                      href="${ctp}/http://www.atguigu.com">服务条款</a>
                        | <a rel="nofollow" href="${ctp}/http://www.atguigu.com">免责声明</a> | <a rel="nofollow"
                                                                                               href="${ctp}/http://www.atguigu.com">网站地图</a>
