...
<form class="form-inline" role="form" style="float:left;" method="post" action="${ctp}/permission/role/list.html">
  <div class="form-group has-feedback">
    <div class="input-group">
      <div class="input-group-addon">查询条件</div>
      <input class="form-control has-success" type="text" name="search" value="${search}" placeholder="请输入查询条件">
    </div>
  </div>
  <button type="button" class="btn btn-warning"><i class="glyphicon glyphicon-search"></i> 查询</button>
</form>
<button id="del_all" type="button" class="btn btn-danger" style="float:right;margin-left:10px;"><i class=" glyphicon glyphicon-remove"></i> 删除</button>
                ...
                <c:forEach items="${pageInfo.list}" var="role">
                    <tr>
                        ...
                        <td>
                            ...
                            <a type="button" class="btn btn-danger btn-xs del_btn"><i class=" glyphicon glyphicon-remove"></i></a>
                        </td>
                    </tr>
                </c:forEach>
